#!/bin/bash
#SBATCH --job-name=pair_erm_base
#SBATCH -t 6-00:00                    # tiempo maximo en el cluster (D-HH:MM)
#SBATCH -o storage/jepa/exp_logs/pairerm_%j.out                 # STDOUT (A = )
#SBATCH -e storage/jepa/exp_logs/pair_erm%j.err                 # STDERR
...
cd storage/jepa
python run_expt.py --train_method pair_erm --dataset shapes3d --seed $seed
